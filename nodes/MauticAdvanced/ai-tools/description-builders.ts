...
const CUSTOM_OPERATION_DESCRIPTIONS: Record<string, Record<string, string>> = {
  ...
  segment: {
    addContact: 'Add a single contact to this segment. Requires segment ID and contact ID.',
    removeContact: 'Remove a single contact from this segment. Requires segment ID and contact ID.',
  },
  companyContact: {
    add: 'Associate a contact with a company. Requires company ID and contact ID.',
    remove:
      'Remove association between a contact and a company. Requires company ID and contact ID.',
  },
  campaignContact: {
